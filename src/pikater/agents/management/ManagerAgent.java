...
public class ManagerAgent extends PikaterAgent {
	...
	protected void setup() {
		...
		try {
			...
			log = Logger.getLogger(ManagerAgent.class);
						...
						LoadAgent la = (LoadAgent) a.getAction();
							...
							if (fa != null){
								...
								getContentManager().fillContent(first_message, ac);
                                                                ...
                                                                try {
                                                                    first_reply = FIPAService.doFipaRequestClient(ManagerAgent.this, first_message);
	...
	private String createAgent(String type, String name, List args){
		...
		while (!agent_created){		
			try {
                String agentType=agentTypes.get(type);
                if (agentType==null) agentType=type;
